...
def start_screen():
    ...
    fon_1 = pygame.image.load('images/photo_zastavka.jpg').convert()
...
def start1_screen():
    fon_2 = pygame.image.load('images/photo_zastavka.jpg').convert()
...
my_car_image = load_image('mercedes.png', (100, 70), -90)
road_image = pygame.image.load('images/road.png')
road_image = pygame.transform.scale(road_image, (500, 800))

car_images = []
car1 = load_image('traffic_car1.png', (100, 70), 90)
car2 = load_image('traffic_car2.png', (100, 70), -90)
car3 = load_image('traffic_car3.png', (100, 70), -90)
